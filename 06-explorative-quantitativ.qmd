# Exploration von quanitativen Daten {#sec-explorative-numerisch}
...
## Hausaufgaben {#sec-ha-kap6}

### Was bedeutet der Code? {#sec-ha-code}
...
### Lab 02: Pünktlichkeit von Flügen
Bearbeiten Sie das Lab 02. Die Besprechung erfolgt in der nächsten Übung.

## Ihre Arbeit einreichen
Reichen Sie die Aufgabe @sec-ha-code bei FelloFish ein und erhalten Sie feedback:

[FelloFish Hausaufgabe](https://app.fiete.ai/a/cm472kf6rjapp14867huka8sh)
