...
2. Die Funktion `dnorm` berechnet den Wert der Warscheinlichkeitsdichte $f(x)$, also einen Punkt auf der Glockenkurve. Berechnen Sie diesen Wert für $x = 0.3$ für die Standardnormalverteilung.
...
Die Studentenvertretung in Werdeschlau möchte wissen, hoch im Schnitt die Studiendauer an der Uni Werdeschlau beträgt.
