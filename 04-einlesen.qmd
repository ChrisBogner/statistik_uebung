...
#| warning: false
#| message: false
umfrage <- read_delim(file = 'Daten/Umfrage_2023_kurz.csv', delim = ';')
...
ggplot(umfrage, mapping = aes(x = `Haben Sie schon mal einen Statistikkurs besucht?`)) +
  ...
  labs(x = 'Antworten',
       ...
       caption = 'Quelle: Umfrageergebnisse Teilnehmende Vorlesung Statistik WS 2023-2024')
```
