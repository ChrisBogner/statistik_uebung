# Einführung in die Darstellung von Daten {#ggplot}
...
## Balkendiagramm
Wie viele Länder gibt es pro Kontinent? Das Balkendiagramm zählt für uns die Einträge im Datensatz zusammen. Es stellt also dieselben Daten dar, die eine Häufigkeitstabelle enthalten würde.
...
Wir verändern die Grafik aus @sec-scatter so, dass die Symbole nach der Größe der Einwohnerzahl skaliert werden. Dazu benutzen wir eine neues Argument in der Funktion `aes(size = pop)`:
