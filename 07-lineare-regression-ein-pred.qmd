...
## Hausaufgaben {#sec-ha-kap7}

### Tutorium 
Bearbeiten Sie das Tutorium "Regression modeling: 4 - Interpreting regression models", das Sie [hier finden](https://openintro.shinyapps.io/ims-03-model-04/). Das Tutorium muss nicht abgegeben werden.


### Vorhersagen {#sec-ha-prediction}
...
Reichen Sie die Aufgabe @sec-ha-prediction bei FelloFish ein und erhalten Sie feedback:

[FelloFish Hausaufgabe](https://app.fiete.ai/a/cm2neicsf04ff46b8fyzhrqlr)
